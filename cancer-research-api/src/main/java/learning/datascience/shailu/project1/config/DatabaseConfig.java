...
@Configuration
@EnableJpaRepositories(basePackages = "learning.datascience.shailu.project1.repository")
...
public class DatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "learning.datascience.shailu.project1.domain" });
